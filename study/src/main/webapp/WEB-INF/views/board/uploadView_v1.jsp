...
<div id="container">
    <form name="inputForm" method="post" onsubmit="return _onSubmit();" action="${path}/board/readExcel?userId=${member.userId}"   enctype="multipart/form-data" class="form-horizontal">
        <div class="panel">
